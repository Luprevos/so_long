...
/*   Updated: 2025/04/01 18:01:11 by luprevos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	new_window_mlx(t_long *data)
{
	...
	data->wall_img = mlx_xpm_file_to_image(data->mlx,
			"image/wall.xpm", &trash, &trash);
	data->vide_img = mlx_xpm_file_to_image(data->mlx,
			"image/vide.xpm", &trash, &trash);
	data->item_img = mlx_xpm_file_to_image(data->mlx,
			"image/item.xpm", &trash, &trash);
	data->player_img = mlx_xpm_file_to_image(data->mlx,
			"image/player.xpm", &trash, &trash);
	data->exitclose_img = mlx_xpm_file_to_image(data->mlx,
			"image/exitclose.xpm", &trash, &trash);
	data->exitopen_img = mlx_xpm_file_to_image(data->mlx,
			"image/exitopen.xpm", &trash, &trash);
	data->playeronexit_img = mlx_xpm_file_to_image(data->mlx,
			"image/playeronexit.xpm", &trash, &trash);
